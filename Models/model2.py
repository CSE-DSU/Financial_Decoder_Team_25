...
def cross_Validation(data):
    ...
    while True:
        ...
        rf_accuracy = metrics.accuracy_score(y_test.values, rf_prediction)
        knn_accuracy = metrics.accuracy_score(y_test.values, knn_prediction)
        ensemble_accuracy = metrics.accuracy_score(y_test.values, ensemble_prediction)
